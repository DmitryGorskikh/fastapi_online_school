...
from app.application.use_cases.tasks.get_task import (
    GetTaskQuery, GetTaskUseCase
)
...
@router.get(
    ...
    description=(
            "Returns the course navigation tree: modules, "
...
@router.get(
    ...
    description='Returns the content of a single '
    'question with public answer options.',
)
...
@router.get(
    ...
    description='Returns the content of a single '
    'task without author check configuration.',
)
async def get_task(
    task_id: UUID,
...
@router.get(
    ...
    description='Returns the content of a single code '
    'task and its editor configuration.',
)
async def get_code_task(
    ...
    result = await use_case.execute(
        GetCodeTaskQuery(code_task_id=code_task_id)
    )
