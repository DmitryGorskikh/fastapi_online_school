...
class ProgressMapper:
    ...
    def to_domain(model: ProgressModel) -> Progress:
        return Progress(
            ...
            completed_task_ids=[
                UUID(item) for item in model.completed_task_ids
            ],
            completed_section_ids=[
                UUID(item) for item in model.completed_section_ids
            ],
            completed_module_ids=[
                UUID(item) for item in model.completed_module_ids
            ],
    ...
    def to_model(entity: Progress) -> ProgressModel:
        return ProgressModel(
            ...
            completed_task_ids=[
                str(item) for item in entity.completed_task_ids
            ],
            completed_section_ids=[
                str(item) for item in entity.completed_section_ids
            ],
            completed_module_ids=[
                str(item) for item in entity.completed_module_ids
            ],
