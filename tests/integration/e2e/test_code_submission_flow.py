...
from app.application.use_cases.code_submissions.complete_code_submission import CompleteCodeSubmissionUseCase  # Noqa E501
from app.application.use_cases.code_submissions.process_code_submission import (  # Noqa E501
...
from app.infrastructure.execution.docker_runner import (
    DockerRunConfig, DockerRunner
)
from app.infrastructure.execution.execution_profile_registry import ExecutionProfile, ExecutionProfileRegistry  # Noqa E501
from app.infrastructure.execution.java_submission_bundle_builder import JavaSubmissionBundleBuilder  # Noqa E501
...
async def test_python_code_submission_flow(
    ...
    course_response = await client.post(
        ...
        json={'title': 'Code course', 'description': 'Course with code tasks.'},  # Noqa E501
    )
    ...
    async with session_factory() as session:
        submissions = (
            await session.execute(select(CodeSubmissionModel))
        ).scalars().all()
